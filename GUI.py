...
class Window(QMainWindow):
    ...
    def __init__(self, config: dict, config_file: str, version: str, frames_processor: FramesProcessor,
        ...
        self.cb_vignette_enabled.setChecked(self.config["vignette_enabled"])
        self.sb_vignette.setValue(int(self.config["vignette"]))
        ...
        self.cb_vignette_enabled.clicked.connect(lambda _: self.update_config(False))
        self.sb_vignette.valueChanged.connect(lambda _: self.update_config(False))
    ...
    def update_config(self, stop_rendering: bool) -> None:
        ...
        self.config["vignette_enabled"] = self.cb_vignette_enabled.isChecked()
        self.config["vignette"] = int(self.sb_vignette.value())
        ...
        self.sb_vignette.setEnabled(self.cb_vignette_enabled.isChecked())
